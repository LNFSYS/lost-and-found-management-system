...
| `npm run e2e:web` | Run Playwright routing, mocked Student LOST/FOUND creation, FOUND claim, Staff review/appointment lifecycle, proof/completion/feedback, match feedback, permission and Admin navigation flows; optional seeded login uses E2E credentials |
