...
| NFR-PRIV-01 | Claim evidence, contact info, private media, chat rooms, and notifications must only be returned to authorized users; public post contact info must be masked by default. | UC-049, UC-054, UC-079, UC-083, UC-089 | P0 | Partial |
