...
BR-47 - Admin được quản lý location: `ADMIN` có thể tạo, sửa, ẩn hoặc kích hoạt khu vực lớn và địa điểm cụ thể; phòng học không quản lý bằng CRUD riêng. UI quản trị không yêu cầu admin nhập thứ tự hiển thị cho khu vực hoặc địa điểm cụ thể.
