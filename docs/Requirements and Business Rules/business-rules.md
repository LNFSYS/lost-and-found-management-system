...
| BR-10 | Claim evidence, private media, contact info, chat rooms, and notifications must only be visible to authorized users. Public post contact info is masked by default; final privacy wording remains a product-policy task. | UC-049, UC-054, UC-078, UC-079, UC-083 | Partial |
